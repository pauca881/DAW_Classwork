     ...
     * Interactúa con DBConnection para acceder a la base de datos.
     * La clase proporciona métodos para listar todas las mascotas, agregar una nueva mascota,
     * buscar una mascota por ID o NIF del propietario, modificar la información de una mascota y eliminar una mascota de la base de datos.
     *
    ...
    class OwnerController implements ControllerInterface
    {
        ...
        public function modify()
        {
            ...
            if (empty($_SESSION["error"])) // If the validation didn't have any errors...
            {
                ...
                if ($ownerFound == NULL) {
                    ...
                    $ownerFinal->setName($ownerInput->getName());
        ...
        public function add()
        {
            ...
            // DISPLAY FORM AGAIN WITH ITEM'S PARAMETERS, AND SUCCESS/ERROR MESSAGES
            $this->view->display("view/form/OwnerFormUpdate.php", $item);
        }
